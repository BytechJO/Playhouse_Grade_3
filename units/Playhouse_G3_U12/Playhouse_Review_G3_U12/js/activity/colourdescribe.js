...
window.ColourDescribe = function (obj, dataObj) {
  ...
  this.currentColor = dataObj.palette.length
    ? dataObj.palette[0].hex
    : "#2f6fb3";

  this.currentWidth = dataObj.brushSizes.length
    ? dataObj.brushSizes[0].width
    : 8;
...
ColourDescribe.prototype = {
  ...
  setupOneCanvas: function (containerEl, dataObj) {
    ...
    boxW: 0,
    boxH: 0,
    brushOpacity: (dataObj.brushOpacity != undefined)
        ? dataObj.brushOpacity
        : 0.45
};
...
tempCtx.lineWidth = self.currentWidth;
  ...
  setupGlobalControls:function(){

    var self = this;

    var swatches = document.querySelectorAll(".paletteSwatch");
    ...
    var brushes=document.querySelectorAll(".brushSizeBtn");
