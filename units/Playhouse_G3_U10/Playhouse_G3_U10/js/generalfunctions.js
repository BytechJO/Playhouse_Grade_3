        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "storywordchoice":
              if (
                typeof storywordchoice_data != undefined &&
                storywordchoice_data != null
              ) {
                buildStoryWordChoiceBody(storywordchoice_data);
              }
              break;
              case "syllablecolour":
              if (
                typeof syllablecolour_data != undefined &&
                syllablecolour_data != null
              ) {
                buildSyllableColourBody(syllablecolour_data);
              }
              break;
          }
        } else {
