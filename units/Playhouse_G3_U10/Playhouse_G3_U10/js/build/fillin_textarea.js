...
function buildFillInBody(aObj) {
  ...
  if (aObj != undefined && aObj != null) {
    ...
    if (layOut == 4) {
      ...
      htmlStmt += '<div class="content-container">';
      htmlStmt += '<div class="img-container">';

      htmlStmt += '<img src="' + aObj.imgData1 + '" style="width:300px"; height:150px; />';
      htmlStmt += '<img src="' + aObj.imgData2 + '" style="width:300px"; height:150px; />';

	       //Options
      htmlStmt += '<div class="drag_drop_options sticky-top center_item">';
      htmlStmt += '<span class="options_title_img"><u>Word Box</u></span>';
      ...
      htmlStmt +=
        '<div class="textarea-container" style="background-image:url(' +
        aObj.background_image +
        ')">';
      htmlStmt +=
