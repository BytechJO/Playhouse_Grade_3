function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="screen_elements d-flex h-100">';
		// options
			...
			for (x = 0; x < numOfQuestions; x++) {
				...
				if (tmpObj.images != '' && tmpObj.images != undefined) {
				  htmlStmt += '<div class="q_image">';
					htmlStmt += '<div class="q_title">'+tmpObj.title+'</div>';
						htmlStmt += '<div class="q_img_1 d-flex flex-column">';
							htmlStmt += '<img src="' + tmpObj.images[0] + '">';
							htmlStmt += '<span>'+tmpObj.images_name[0]+'</span>';
				  		htmlStmt += '</div>';

						htmlStmt += '<div class="q_img_2 d-flex flex-column">';
						  htmlStmt += '<img src="' + tmpObj.images[1] + '">';
						  htmlStmt += '<span>'+tmpObj.images_name[1]+'</span>';
						htmlStmt += '</div>';
				  htmlStmt += '</div>';
				}
