var _data = {
    ...
    "header": {
        ...
        "bgcolor": "linear-gradient(180deg, #faa361 0%, rgba(255,255,255,0) 100%)",
    ...
    "footer": {
        ...
        "bgcolor": "linear-gradient(0deg, #faa361 0%, rgba(255,255,255,0) 100%)",       
        "buttons"    : [],
        "filetoload" : [],
        "homebutton" : {
        ...
        "booksbutton" : {
            "workbook": {
                ...
                'link'      : '../../Playhouse_G3_U10/views/free_fillin_on_image.html'
            },
            "studentbook": {
