          ...
          switch (_fileType) {
            ...
            case "countablenouns":
              if (
                ...
                buildCountableNounsBody(countablenouns_data);
              }
              break;
            case "fillcircletype":
              if (
                typeof fillcircle_data != undefined &&
                fillcircle_data != null
              ) {
                buildFillCircleTypeBody(fillcircle_data);
              }
              break;
            case "punctuation":
              if (
                typeof punctuation_data != undefined &&
                punctuation_data != null
              ) {
                buildPunctuationBody(punctuation_data);
              }
              break;
          }
        } else {
