var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_32/UNIT_4_Thats_My_Favourite_Dish.mp3",
       "title":{
           "text": "That’s My Favourite Dish",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : './Playhouse_Review_G3_U4/views/fillin_text_in_sentences_5.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G3_U4/views/fillin_under_img.html'
            },
            "studentbook": {
