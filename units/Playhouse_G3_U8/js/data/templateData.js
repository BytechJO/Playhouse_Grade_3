var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_68/UNIT_8_Its_in_the_Kitchen.mp3",
       "title":{
           "text": "It’s in the Kitchen",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : './Playhouse_Review_G3_U8/views/match_img_horizantal.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G3_U8/views/free_fillin_on_image.html'
            },
            "studentbook": {
