//  ****************************************** //
//  StoryWrite - Version no: 1
//  Static story text (no interaction) + a single free-write textarea, no validation
//  ****************************************** //
window.StoryWrite = function(obj, dataObj){
    ob = obj[0].getElementsByClassName("options");
    console.log('StoryWrite > ', $('.activity_area'));
    this.settings = {
        'activity_area' : ob[0],
...
StoryWrite.prototype = {
    ...
    listen:function(ob){
        ...
        var textarea = e.querySelector('.sw_textarea');
