        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "letterpath":
              ...
              break;
            case "storycircleunderline":
              if (
                typeof storycircleunderline_data != undefined &&
                storycircleunderline_data != null
              ) {
                buildStoryCircleUnderlineBody(storycircleunderline_data);
              }
              break;

            case "circleimageword":
              if (
                typeof circleimageword_data != undefined &&
                circleimageword_data != null
              ) {
                buildCircleImageWordBody(circleimageword_data);
              }
              break;
                case "storywrite":
              if (
                typeof storywrite_data != undefined &&
                storywrite_data != null
              ) {
                buildStoryWriteBody(storywrite_data);
              }
              break;
          }
        } else {
