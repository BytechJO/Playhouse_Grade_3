...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "circleimageword") {
    theActivity = new CircleImageWord(quePart, circleimageword_data);
  } else if (aActTyp == "storycircleunderline") {
    theActivity = new StoryCircleUnderline(quePart, storycircleunderline_data);
  } else if (aActTyp == "storywrite") {
    theActivity = new StoryWrite(quePart, storywrite_data);
