...
var fillin_data = {    
    ...
    "subTitleTextLeft"      : '<span class="orange_text">2</span> Pair work.',
    "subTitleTextRight"     : '<span class="orange_text">In pairs, practise the conversation. Then try to use the words below to make a new conversation. Act it out for the class.</span>',
    "subTitleIcons"         : [""],
    "subTitleAudio"         : "../audios/new/p49pair.mp3",
    "defaultAnswer"         : -1,
    "leftList"              : '',
    "image"                 : "",
    "question"              :"",
