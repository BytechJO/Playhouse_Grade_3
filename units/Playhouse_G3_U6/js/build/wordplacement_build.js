	...
	if(typeof aObj !=undefined && aObj !=null){
		...
		htmlStmt += '<div class="group_elm wp_group flex-column">';
			...
			for (var x = 0; x < numOfQuestions; x++) {
				...
				htmlStmt += '<div class="que wp_item d-flex align-items-center flex-wrap" data-qno="' + (x + 1) + '">';
					...
					for (var g = 0; g < numGaps; g++) {
						htmlStmt += '<input class="text_input_area wp_gap" type="text" maxlength="' + aObj.maxlength + '" data-gap="' + g + '">';
