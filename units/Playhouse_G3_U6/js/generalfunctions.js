        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "familyconnection":
              if (
                typeof familyconnection_data != undefined &&
                familyconnection_data != null
              ) {
                buildFamilyConnectionBody(familyconnection_data);
              }
              break;
            case "wordsort3":
              if (
            ...
            case "listenandnumber":
              if (
                typeof listenandnumber_data != undefined &&
                listenandnumber_data != null
              ) {
