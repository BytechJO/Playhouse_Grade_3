      ...
      if (slide.layout == "text_on_image") {
        if (slide.wordsBackground != undefined) {
          ...
          for (var wordsIndex = 0; wordsIndex < allWords.length; wordsIndex++) {
            slideHtml +=
              "<div class='snap_card audioIcon mx-0 mx-md-auto audioTile' data-slideNum='" +
              Number(slideIndex + 1) +
              "' data-audio='" +
        ...
        for (
          ...
          if (conv.songText != undefined) {
            ...
            slideHtml +=
              "<img src='" + conv.img + "' class='img-" + convIndex + "' />";
          }
          slideHtml += "</div>";
          slideHtml += "</div>";
        }
        ...
        slideHtml +=
          "<div class='gram_btn rule pulse rule_toggle_btn'>Rule</div>";
        slideHtml +=
          "<div class='gram_btn Example pulse example_toggle_btn'>Example</div>";
        slideHtml += "</div>";
        slideHtml +=
        ...
        if (slide.mainImage) {
          slideHtml +=
            "<img src='" +
            slide.mainImage +
            "' style='height: 755px; margin-top:-30px;'/>";
        }
          ...
          if (slide.grid_main_title_text.length > 1) {
            for (let x = 0; x < slide.grid_main_title_text.length; x++) {
              slideHtml +=
                ...
                x +
                " pulse'>" +
                slide.grid_main_title_text[x] +
                "</div>";
            }
          } else {
            slideHtml +=
              "<div class=''>" + slide.grid_main_title_text + "</div>";
          }
          slideHtml += "</div>";
          slideHtml += "</div>";
        }
        ...
        slideHtml += "</div>";
      } else if (slide.layout == "speech_bubbles") {
        // NEW: uses a real background image (book page with tabs + spiral
        // binding already part of the picture) instead of CSS-drawn shapes.
        slideHtml += "<div class='speech_bubbles_page'>";

        if (slide.bgImage != undefined && slide.bgImage != "") {
          slideHtml +=
            "<img src='" + slide.bgImage + "' class='speech_bubbles_bg'/>";
        }

        for (var bIndex = 0; bIndex < slide.bubbles.length; bIndex++) {
          var bub = slide.bubbles[bIndex];

          slideHtml +=
            "<div class='speech_bubble tail_" +
            bub.tailSide +
            "' style='top:" +
            bub.bubblePos.top +
            "; left:" +
          ...
          slideHtml +=
            ...
            bub.textAudio +
            "' data-onaudioplay='color:#e43b6d'>";
          slideHtml += "<p class='bubble_text'>" + bub.text + "</p>";
          slideHtml += "</div>";
          slideHtml += "</div>";

          slideHtml +=
            "<div class='speech_avatar_group' style='top:" +
            bub.avatarPos.top +
            "; left:" +
            bub.avatarPos.left +
            ";'>";
        //   slideHtml +=
        //     "<img src='" + bub.avatar + "' class='speech_avatar_img'/>";
        //   slideHtml += "<div class='speech_avatar_name'>" + bub.name + "</div>";
          slideHtml += "</div>";
        }
