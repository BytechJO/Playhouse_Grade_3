function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		if(aObj.images != undefined && aObj.images != ""){
			htmlStmt += '<div class="images_container d-flex flex-wrap">';
			for(let i=0; i < aObj.images.length; i++){
				htmlStmt += '<div class="audioIcon off d-flex contant" data-audio="'+aObj.imagesAudios[i]+'">' ;
				htmlStmt += '<img src="'+aObj.images[i]+'" class="img img_'+i+'">';
				htmlStmt += '</div>';
			}
			htmlStmt += '</div>';
		}
