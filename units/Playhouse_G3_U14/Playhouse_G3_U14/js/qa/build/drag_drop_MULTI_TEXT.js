function initActivity(activity){
	...
	jQuery.each(activity.questions, function(key, values){
		...
		if(typeof(values)=="string"){
			...
			drag_drop_questions += '<div class="i_container"><div class="i_row d-flex flex-wrap justify-content-center align-items-center"><div class="l_col"></div><div class="r_col"><div class="droppable_text_div">'
