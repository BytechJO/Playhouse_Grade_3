function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		// ===========================================================
		htmlStmt += '<div class="screen_elements ss d-flex justify-content-center align-items-center h-100">';
	...
	htmlStmt += '<div class="image-container"><img src="../images/pages/activities/p6_2.png"/></div>';
