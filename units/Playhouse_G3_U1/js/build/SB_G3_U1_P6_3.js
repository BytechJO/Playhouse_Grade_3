function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="group_elm d-flex flex-column justify-content-center align-items-center mb-70">';
	...
	// console.log("************")
	// var group1Items = document.getElementsByClassName("group1");
	// console.log(group1Items.length);

	// var groupDiv1 = document.createElement("span");
	// groupDiv1.classList.add("Group1");


	// for(let x=0; x < 3; x++){
	// 	let item = group1Items[x];
	// 	console.log(item)
	// 	groupDiv1.append(item)
	// }
	

	// console.log(groupDiv1);
