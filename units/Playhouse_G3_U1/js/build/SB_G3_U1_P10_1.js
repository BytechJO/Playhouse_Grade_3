function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="group_elm d-flex flex-wrap justify-content-center align-items-star mb-70">';
		
			
			htmlStmt += '<div class="story_gr">';
				for(let s=0; s<aObj.story.length; s++){
					htmlStmt += '<div class="audioIcon story off d-flex contant" data-audio="">' ;
						htmlStmt += '<div class="storyText">' + aObj.story[s] + '</div>';
					htmlStmt += '</div>';
				}
				for (x = 0; x < numOfQuestions; x++) {
					...
					htmlStmt += '<div class="q_space d-flex flex-column">';
						...
						if(tmpObj.textEnd != undefined && tmpObj.textEnd != ""){
							htmlStmt += '<div class="audioIcon txt-audioIcon textEnd off d-flex contant" data-audio="">' ;
