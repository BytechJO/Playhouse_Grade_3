		...
		for(x= 0;x<numberofCols;x++){	
			...
			for(y= 0;y<numOfQinCol;y++){
				...
				if(typeof tpOb != undefined && tpOb != null ){
					...
					htmlStmt += '<div class="'+className+' d-flex flex-wrap" id="que_'+currQueNum+'" data-qno="'+currQueNum+'">';
                    ...
                    // :( 
					//   temporary we have to change this condition ...  
					//   case : when answer of question is none ...  
					// :(  
					if(tpOb.answer == 0){
			...
			htmlStmt += '<img src="../images/pages/activities/p9_2.png"/>';
			htmlStmt += '</div>';
