...
function initiateActivityType(aActTyp, aActSubType) {
  ...
  } else if (aActTyp == "freewrite") {
    theActivity = new FreeWrite(quePart, freewrite_data);
  }
  else if (aActTyp == "crossoutgrid") {
    theActivity = new CrossOutGrid(quePart, crossoutgrid_data);
