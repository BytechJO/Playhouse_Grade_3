        ...
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "linedraw":
              ...
              break;
               case "freewrite":
              if (typeof freewrite_data != undefined && freewrite_data != null) {
                buildFreeWriteBody(freewrite_data);
              }
              break;
          }
        } else {
...
$(window).on("orientationchange", function (event) {
  if (
    ...
    $(".activity_area").data("type") == "dragndrop"
  ) {
    $(".loading").show();
    alert(
      "Changing orientation or resizing the screen will reset the activity!",
    );
    theActivity.reset();
