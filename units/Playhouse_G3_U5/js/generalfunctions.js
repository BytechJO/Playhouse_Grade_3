      ...
      if (_fileType != "" && _fileBuild != "") {
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "readingcircle":
              if (
                typeof readingcircle_data != undefined &&
                readingcircle_data != null
              ) {
                buildReadingCircleBody(readingcircle_data);
              }
              break;
              case "howmuchmany":
              if (
                typeof howmuchmany_data != undefined &&
                howmuchmany_data != null
              ) {
                buildHowMuchManyBody(howmuchmany_data);
              }
              break;
               case "dragingredients":
              if (
                typeof dragingredients_data != undefined &&
                dragingredients_data != null
              ) {
                buildDragIngredientsBody(dragingredients_data);
              }
              break;
          }
        } else {
