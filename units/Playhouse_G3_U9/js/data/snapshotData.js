...
var Popups_data = {
  slides: [
    {
      listen: {
        ...
        titlesAudio: [
          "../audios/page_76/1_Listen_and_say_the_words.mp3",
        ...
        audio: [
          "../audios/page_76/1_measuring_cups.mp3",
          "../audios/page_76/2_oven_gloves.mp3",
          "../audios/page_76/3_cutting_board.mp3",
          "../audios/page_76/4_frying_pan.mp3",
          "../audios/page_76/5_pot.mp3",
          "../audios/page_76/6_blender.mp3",
          "../audios/page_76/7_food_processor.mp3",
          "../audios/page_76/8_peeler.mp3",
          "../audios/page_76/9_grater.mp3",
          "../audios/page_76/10_spatula.mp3",
          "../audios/page_76/11_rolling_pin.mp3",
          "../audios/page_76/12_toaster.mp3",
          "../audios/page_76/13_grill.mp3",
        ],
      },
      listen2: {
  ...
  postions: [
    ...
    "left: 67%; top: 63%;",
    "left: 73%; top: 83%;",
    // "left:590px; top:284px;",
    // "left:600px; top:284px;",
  ],
  imagesAudio: [
    "../audios/page_76/1_measuring_cups.mp3",
    "../audios/page_76/2_oven_gloves.mp3",
