        ...
        for (var slideIndex = 0; slideIndex < aObj.slides.length; slideIndex++) {
            ...
            if (slide.layout == 'text_on_image'){
                ...
                for (var convIndex = 0; convIndex < slide.convImage.length; convIndex++) {
                    ...
                    slideHtml += "<div class='snap_card mx-0 mx-md-auto' data-slideNum='" + Number(slideIndex + 1) + "' data-audio='" + conv.audio + "'data-onaudioplay='color:#e43b6d'>"
                    if (conv.songText != undefined){
                        slideHtml += "<p class='song_text'>" + conv.songText + "'</p>";
                    } else {
                        slideHtml += "<img src='" + conv.img + "' class='img-" + convIndex + " pulse' />";
                    }
                    slideHtml += "</div>";
                    slideHtml += "</div>";
                }
            ...
            slideHtml += "</div>";
                ...
                slideHtml += "<div class='col_grid_container'>";
                    if(slide.mainImage){
                        slideHtml += "<img src='" + slide.mainImage + "' style='height: 665px; margin-top:-30px;'/>";
                    }
