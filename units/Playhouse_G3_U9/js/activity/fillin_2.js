...
FillIn.prototype = {
  ...
  validate: function () {
    ...
    for (var i = 0; i < elsQue.length; i++) {
      ...
      // NEW: questions with no blank at all (no [_] in the text -> no <input>
      // was built) don't need validation - treat them as trivially correct
      // and never show a tick/cross for them.
