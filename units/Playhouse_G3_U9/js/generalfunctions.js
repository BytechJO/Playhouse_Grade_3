      ...
      if (_fileType != "" && _fileBuild != "") {
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "matchlocations":
              if (
                typeof matchlocations_data != undefined &&
                matchlocations_data != null
              ) {
                buildMatchLocationsBody(matchlocations_data);
              }
              break;
               case "chooseandwrite":
              if (
                typeof chooseandwrite_data != undefined &&
                chooseandwrite_data != null
              ) {
                buildChooseAndWriteBody(chooseandwrite_data);
              }
              break;
          }
        } else {
