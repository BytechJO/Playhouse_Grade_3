...
function buildWordSort3Body(aObj) {
  ...
  if (typeof aObj != undefined && aObj != null) {
    ...
    htmlStmt +=
      '<div class="all_cont justify-content-start justify-content-sm-center flex-column">';

    // ---------------- numbered word bank ----------------
    htmlStmt +=
      '<div class="ws3_bank d-flex flex-wrap justify-content-center">';
    jQuery.each(aObj.words, function (i, wObj) {
      htmlStmt +=
        '<div class="ws3_bank_chip draggable_word" data-wordid="' +
        wObj.id +
        '">';
    ...
    // ---------------- the 3 ruled tables ----------------
    htmlStmt +=
      '<div class="ws3_tables d-flex flex-wrap justify-content-center">';
    htmlStmt +=
'<img class="sideImg" src="' + aObj.sideImg + '" style= "width:515px" />'
    jQuery.each(aObj.tables, function (tIndex, tObj) {
      ...
      htmlStmt +=
        '<div class="ws3_table_box" style="grid-template-columns: repeat(' +
        tObj.numCols +
        ', 1fr);">';
      ...
      for (var c = 0; c < tObj.numCols; c++) {
        ...
        for (var r = 0; r < tObj.rowsPerCol; r++) {
          htmlStmt +=
            '<div class="ws3_line ws3_slot" data-tableid="' +
            tObj.id +
            '"></div>';
        }
