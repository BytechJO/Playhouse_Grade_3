...
var fillin_data = {
  ...
  "subTitleTextRight"     : "Complete each word.",
  "subTitleIcons"         : ["../images/pages/sb-icons/gram_2_icon.png"],
  "subTitleAudio"         : "../audios/new/p101write.mp3",
  "image"                 : "",
  ...
  "questions":
    ...
    "items":
        [
          ...
          "<span class='text'>"+
          "The butterfly is <span class='red_text'>more</span><br>"+
          "<span class='orange_text'>interesting</span> <span class='red_text'>than</span> the <br>"+
          "caterpillar. <br>"+
          "The Monarch butterfly is <br>"+
          "<span class='red_text'>the most</span> <span class='orange_text'>colourful</span> of <br>"+
          "all the butterflies."+
          "</span>",
