function buildFillInBody(aObj) {	
	...
	if(typeof aObj !=undefined && aObj !=null){		
		...
		htmlStmt += '<div class="group_elm d-flex flex-wrap">';
			...
			for (x = 0; x < numOfQuestions; x++) {
				...
				if (tmpObj.image != '' && tmpObj.image != "no") {
				  htmlStmt += '<div class="q_image" data-qno="' + (x + 1) + '"><img src="' + tmpObj.image + '" class="back_img">';
				}
				...
				htmlStmt += '<div class="fillin_gr d-flex flex-column align-items-center">';
				...
				if(tmpObj.textEnd != undefined && tmpObj.textEnd != ""){
					htmlStmt += '<div class="audioIcon textEnd off d-flex contant " data-audio="' + tmpObj.textEnd_audio[x] + '">' ;
