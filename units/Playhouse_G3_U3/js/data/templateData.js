var _data = {
    ...
    "header": {
       ...
       "audio": "./audios/page_20/UNIT_3_On_Mondays_We_Play_Tennis.mp3",
       "title":{
           "text": "On Mondays, We Play Tennis!",
    ...
    "footer": {
        ...
        "reviewbutton" : {
            'visible'   : 'yes', // yes (or) no
            'link'      : './Playhouse_Review_G3_U3/views/match_img_horizantal.html'
        },
        "booksbutton" : {
            "workbook": {
                'icon'   : '../images/icons/book-2.png',
                'link'      : '../Playhouse_G3_U3/views/free_fillin_on_image.html'
            },
            "studentbook": {
