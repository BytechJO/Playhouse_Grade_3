      ...
      if (_fileType != "" && _fileBuild != "") {
        if (_fileBuild == "yes") {
          switch (_fileType) {
            ...
            case "tickimageitems":
              if (
                typeof tickimageitems_data != undefined &&
                tickimageitems_data != null
              ) {
                buildTickImageItemsBody(tickimageitems_data);
              }
              break;
            case "circlecorrectpic":
              if (
                typeof circlecorrectpic_data != undefined &&
                circlecorrectpic_data != null
              ) {
                buildCircleCorrectPicBody(circlecorrectpic_data);
              }
              break;
          }
        } else {
