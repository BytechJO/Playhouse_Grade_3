//  ****************************************** //
//  ColourDescribe - Version no: 1
//  Free-hand colouring canvas (palette + brush) + a free-write description
//  textarea below it. No validation for either part.
//  ****************************************** //
...
ColourDescribe.prototype = {
    ...
    listen:function(ob){
        ...
        // free-write description
        // var textarea = e.querySelector('.cd_textarea');
