function buildMcqTickBody(aObj) {
    ...
    if (aObj != undefined && aObj != null) {
        ...
        if (layOut == 1) {
            ...
            htmlStmt += '<div class="all_cont d-flex justify-content-start justify-content-sm-center align-items-center">';
          
            htmlStmt += '<div class="tick_group d-flex" style="width:100%">'; 
            // htmlStmt += ' <div class="heading">' + aObj.question + '</div> ';
            for (x = 0; x < numOfQuestions; x++) {
                ...
                htmlStmt += '<div class="que_group w-100 d-flex flex-wrap justify-content-center align-items-center">';
             //   htmlStmt += '<div class="image_wrap"><img src="' + tempObj.image + '"></div>';
                ...
                for (y = 0; y < ((tempObj).options).length; y++) {
                    htmlStmt += ' <div id="pick_' + (x + 1) + '_' + (y + 1) + '" class="tick_field d-flex flex-column gap-20 pick background_audio align-items-baseline"> ';
