...
var fillin_data = {
  ...
  "questions"             : [
    {
      "singleword": false,
      "text": "Jenny leaves the school and walks [_] Queen St.",
    ...
    {
      "singleword": false,
      "text": "Next, Jenny turns [_] on Lake St.",
      "textaudios": ["../audios/under.mp3","../audios/under.mp3"],
      "audio": "",
      "audioenable": "default", // correct (or) default
      "image": "",
    ...
    {
      "singleword": false,
      "text": "At [_] [_] , Jenny will turn [_].",
      "textaudios": ["../audios/under.mp3","../audios/under.mp3"],
      "audio": "",
      "audioenable": "default", // correct (or) default
      "image": "",
      "answer": ["Station","Road","right"],
      "alternateanswer": [[]],
      "strictcase": "no", // yes (or) no     
      "strictorder": "yes", // yes (or) no             
      "maxlength": 200,
    ...
    {
      "singleword": false,
      "text": "Lilly’s house is on the [_] side, next to the [_].",
      "textaudios": ["../audios/under.mp3","../audios/under.mp3"],
      "audio": "",
      "audioenable": "default", // correct (or) default
      "image": "",
      "answer": ["left","supermarket"],
      "alternateanswer": [[]],
      "strictcase": "no", // yes (or) no     
      "strictorder": "yes", // yes (or) no             
      "maxlength": 200,
